  ...
  return (
    <>
      ...
      <nav className="bg-black text-white px-6 py-4 flex justify-between items-center shadow-lg sticky top-0 z-40">
        ...
        {user ? (
          <div className="flex items-center gap-4">
            <div className="hidden py-2 px-2 sm:block text-right">
              <p className="text-sm  text-gray-400 font-bold uppercase leading-none">Status</p>
              <p className="text-sm font-bold uppercase mt-2 leading-none text-blue-400  ">{user.role}</p>
            </div>
