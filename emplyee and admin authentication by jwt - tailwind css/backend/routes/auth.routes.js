...
const {register,getAdmins, login,getEmployee,updateEmployee ,getOwndata,deleteEmployee,searchEmployee}=require('../controllers/auth.controller.js')
...
router.get('/employees/search', auth, role("admin"), searchEmployee);
router.get('/admins', auth, role("employee"), getAdmins);
